...
class SSDMetaArch(model.DetectionModel):
  ...
  def __init__(self,
    ...
    Args:
      ...
      box_coder: a box_coder.BoxCoder object. Box coders convert between 
                 coordinate frames, namely image-centric (with (0,0) on the 
                 top left of image) and anchor-centric (with (0,0) being
                 defined by a specific anchor).
                 It is not the job of a BoxCoder to perform matching.
      feature_extractor: a SSDFeatureExtractor object.
      matcher: a matcher.Matcher object.
               Seems to be used for matching default boxes to the ground truth 
               boxes at training phase, as described in the paper.
