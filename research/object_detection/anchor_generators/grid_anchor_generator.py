...
def tile_anchors(grid_height,
  ...
  heights = scales / ratio_sqrts * base_anchor_size[0]  # [0.2 / 1.0 * 1.0, ...]
  widths = scales * ratio_sqrts * base_anchor_size[1]

  # Get a grid of box centers
  y_centers = tf.to_float(tf.range(grid_height))  # [0, 1, ..., 9]
  y_centers = y_centers * anchor_stride[0] + anchor_offset[0]  # [3*1.0/10+0.5/10, ...]
